/**
 * Shows the weather for a specific city
 * 
 * @param cityName - Name of the city (string)
 * @param parsedTemp - Temp of the city (string)
 * @param condition - Condition of the city (string)
 * 
 */
